...
try{
 ...
 let bowler= require('./top10economicbowler.js');
 if(bowler)
 {
...
Promise.all(peryearmatches(string1,4),peryearwiner(string1,4),extrarun(string1,4),bowler(string1,4)).then(results =>{console.log("All function run succesfully")}).catch(error =>{console.log("Failed! All function not run succesfully")});